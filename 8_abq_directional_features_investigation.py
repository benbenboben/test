...
train.trim_dates(None, '01-01-2015')
test = cs_detection.ClearskyDetection(nsrdb.df, scale_col=None)
test.trim_dates('11-01-2015', '11-02-2015')
...
test.df[feature_cols + ['GHI', 'Clearsky GHI pvlib']].iplot()
...
runs_df.to_csv('8_abq_directional_features_investigation.csv')
...
test.trim_dates('11-01-2015', '12-01-2015')
train.scale_model('GHI', 'Clearsky GHI pvlib', 'sky_status')
