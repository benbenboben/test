...
detect_obj = cs_detection.ClearskyDetection.read_pickle('ornl_nsrdb_1.pkl.gz', 'GHI', 'Clearsky GHI pvlib', 'sky_status')
detect_obj.df.index = detect_obj.df.index.tz_convert('EST')
...
dflt_detect_obj = cs_detection.ClearskyDetection.read_pickle('ornl_nsrdb_1.pkl.gz', 'GHI', 'Clearsky GHI pvlib', 'sky_status')
dflt_detect_obj.df.index = dflt_detect_obj.df.index.tz_convert('EST')
...
clean_detect_obj = cs_detection.ClearskyDetection.read_pickle('ornl_nsrdb_1.pkl.gz', 'GHI', 'Clearsky GHI pvlib', 'sky_status')
clean_detect_obj.df.index = clean_detect_obj.df.index.tz_convert('EST')
