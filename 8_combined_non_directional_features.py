...
with warnings.catch_warnings():
    ...
    for depth, nest, cw, min_samples in itertools.product(params['max_depth'], params['n_estimators'], params['class_weight'], params['min_samples_leaf']):
        ...
        results.append({'max_depth': depth, 'n_estimators': nest, 'class_weight': cw, 'min_samples_leaf': min_samples,
                        ...
                        'ornl_accuracy': ornl_accuracy_score, 'ornl_f1': ornl_f1_score, 'ornl_recall': ornl_recall_score, 'ornl_precision': ornl_precision_score})
...
results_df['mean accuracy'] = np.mean(results_df[['abq_accuracy', 'srrl_accuracy', 'ornl_accuracy']], axis=1)
...
results_df['mean recall'] = np.mean(results_df[['abq_recall', 'srrl_recall', 'ornl_recall']], axis=1)
...
results_df.to_csv('8_combined_non_direction_features_results.csv')
...
results_df = pd.read_csv('8_combined_non_direction_features_results.csv')
